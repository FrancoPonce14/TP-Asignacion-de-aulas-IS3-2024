...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/aula/**", "/edificio/**", "/departamento/**", "/carrera/**", "/materia/**").hasAnyAuthority("PERFIL_AUDITOR", "PERFIL_ADMIN")
		.antMatchers("/notaPedido/index", "/notaPedido/crearPedido", "/notaPedido/auditor/**").hasAuthority("PERFIL_AUDITOR")
